...
- Sessions allow users to access restricted areas without having to login every time, they only need to login once.

1. What does bcrypt do to help us store passwords in a secure manner.

- It hashes and encrypts the password.

1. What does bcrypt do to slow down attackers?

- It hashes the password multiple times, as many times as the dev sets it to.
